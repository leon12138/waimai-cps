	...
	<view class="my">
		...
		<view class="flex user-box topinfo">
			...
			<!-- 	<view v-if="appid!='wxf86d40ecd6914158'" class="u-font-12 u-p-t-10">ID:{{userInfo.id}}</view>
				...
				<view class="u-font-12 u-p-t-10">微信公众号【外卖很忙】ID:{{userInfo.id}}</view>
			</view>
		</view>
		<!-- 功能区域 -->
		<view class="fc">
			...
			<view class="price">
				<view class="top flex justify-between" style="border-bottom: 4px solid rgba($color:#ccc, $alpha:0.7);">
					<view>
						...
						<view class="u-m-t-10">{{userInfo.available_money || '0' | zeroize}}</view>
					</view>
					<view>
			...
			<view class="u-m-t-10 fclist">
				<u-cell-group>
					<navigator url="/pages/wallet/wallet?currentid=0">
