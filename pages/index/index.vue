	...
	<view class="container">
		...
		<view class="coupon" ref="coupon">
			...
			<view class="tabs flex justify-around">
				<view class="tabs-item" @click="jump(projectList[0],1)">
					<view>
...
<!-- 		<view class="ad-view" v-if="appInfo.ad_unit_id">
			<ad :unit-id="appInfo.ad_unit_id" ad-intervals="100"></ad>
		</view> -->
	...
	export default {
		...
		onLoad(e) {
			...
			if (!is_rodom) {
				...
				if ((new Date()).getTime() - assig.timestamp > 60 * 60 * 1000) {
					...
					this.$set(this.projectList[0], 'number', assig.meituan_num)
					this.$set(this.projectList[1], 'number', assig.ele_num)
		...
		methods: {
			...
			assignment() {
				...
				this.$set(this.projectList[0], 'number', rodom_num.meituan_num)
				this.$set(this.projectList[1], 'number', rodom_num.ele_num)
